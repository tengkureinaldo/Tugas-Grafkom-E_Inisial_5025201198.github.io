function main(){
    ...
    glMatrix.mat4.perspective(projmatrix, //matriks proyeksi
        glMatrix.glMatrix.toRadian(60), //sudutnya
        1.0, //aspect ratio
        0.5, //near
        10.0 //far
        );
    ...
    glMatrix.mat4.lookAt(viewmatrix,//matriks view
        [-4.0, -1.0, 6.0],//posisi kamera (posisi)
        [0.0, 0.0, 2],//arah kamera menghadap (vektor)
    ...
    var animate = function(){
        if(!freeze){
            glMatrix.mat4.rotate(modmatrix, modmatrix, theta, [10.0,0.0,-6.0]);
        }
